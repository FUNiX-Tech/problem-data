...
Thay đổi cấ u trúc như thêm/thiếu thẻ h1, nội dung class, text sẽ tính là sai hết.
...
```html
<h1 style="color: #f00" class="red-text">I am red!</h1>
<h1 style="color: #f0f" class="fuchsia-text">I am fuchsia!</h1>
<h1 style="color: #0ff" class="cyan-text">I am cyan!</h1>
<h1 style="color: #0f0" class="green-text">I am green!</h1>
```
