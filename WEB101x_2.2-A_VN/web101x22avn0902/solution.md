...
<button class="follow-btn" style="display: flex"></button>
<footer style="display: flex"></footer>
<h3 style="display: flex"></h3>
<h4 style="display: flex"></h4>
<p class="profile-name" style="display: flex"></p>
<p class="stats" style="display: flex"></p>
```
